...
public class TermAction implements Serializable {
	private Vertex vertex;

	public TermAction() {
	}

	public TermAction(Vertex vertex) {
		super();
		this.vertex = vertex;
	}
	...
	public String getLabel() {
		return SchemaConstants.LABEL_TERM_ACTION;
	}

	public static TermAction rowMapper(Map<String, Object> map) {
		if (map == null || map.isEmpty())
			return null;

		return new TermAction(new Vertex(SchemaConstants.LABEL_TERM_ACTION, map));
	}
