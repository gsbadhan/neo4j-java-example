...
public class ConfigItem implements Serializable {
	...
	public ConfigItem(Vertex vertex) {
		super();
		this.vertex = vertex;
	}
	...
	public String getLabel() {
		return SchemaConstants.LABEL_CONFIG_ITEM;
	}

	public static ConfigItem rowMapper(Map<String, Object> map) {
		if (map == null || map.isEmpty())
			return null;

		return new ConfigItem(new Vertex(SchemaConstants.LABEL_CONFIG_ITEM, map));
	}
