...
public class TermActionType implements Serializable {
	private Vertex vertex;

	public TermActionType() {
	}

	public TermActionType(Vertex vertex) {
		super();
		this.vertex = vertex;
	}
	...
	public static TermActionType rowMapper(Map<String, Object> map) {
		if (map == null || map.isEmpty())
			return null;

		return new TermActionType(new Vertex(SchemaConstants.LABEL_TERM_EVENT_TYPE, map));
	}
