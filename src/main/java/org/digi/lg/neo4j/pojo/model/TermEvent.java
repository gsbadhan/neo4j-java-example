...
public class TermEvent implements Serializable {
	...
	public TermEvent(Vertex vertex) {
		super();
		this.vertex = vertex;
	}
	...
	public String getLabel() {
		return SchemaConstants.LABEL_TERM_EVENT;
	}

	public static TermEvent rowMapper(Map<String, Object> map) {
		if (map == null || map.isEmpty())
			return null;

		return new TermEvent(new Vertex(SchemaConstants.LABEL_TERM_EVENT, map));
	}
