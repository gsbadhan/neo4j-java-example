...
public class TermData implements Serializable {
	...
	public String getLabel() {
		return SchemaConstants.LABEL_TERM_DATA;
	}

	public static TermData rowMapper(Map<String, Object> map) {
		if (map == null || map.isEmpty())
			return null;

		return new TermData(new Vertex(SchemaConstants.LABEL_TERM_DATA, map));
	}
